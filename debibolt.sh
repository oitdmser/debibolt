...
# set data locations
bitcoin_dir="~/.bitcoin" #bitcoind base dir. Default is ~/.bitcoin NOTE:leave the last '/' off the path

#LND info. This version uses an RPCauth user and PW (generated by rpauth.py) for LND to connect to bitcoind
lnd_dir="~/.lnd/data/chain/bitcoin/mainnet" #location of readonly.macaroon default: /home/USER/.lnd/data/chain/bitcoin/mainnet NOTE:leave the last '/' off the path
tls_dir="~/.lnd" #location of tls.cert default: /home/USER/.lnd  NOTE:leave the last '/' off the path
